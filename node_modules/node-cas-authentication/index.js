...
CASAuthentication.prototype._login = function(req, res, next) {
    ...
    req.session.cas_return_to = req.query.returnTo || this.return_to || url.parse(req.url).pathname;
